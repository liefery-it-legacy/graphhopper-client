...
# Unit tests for GraphHopper::ResponseCoordinates
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseCoordinates' do
  before do
    # run before each test
    @instance = GraphHopper::ResponseCoordinates.new
  end
  ...
  describe 'test an instance of ResponseCoordinates' do
    it 'should create an instance of ResponseCoordinates' do
      expect(@instance).to be_instance_of(GraphHopper::ResponseCoordinates)
    end
  end
